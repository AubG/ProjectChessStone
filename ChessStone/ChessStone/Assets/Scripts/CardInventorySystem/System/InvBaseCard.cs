...
public class InvBaseCard
{
	public enum Slot
	{
		...
		Blob,			// All the following elements are yours to customize -- edit, add or remove as you desire
		Crystal,
		Absorb,
		Illusion,
		Builder,
	...
	public List<InvCard> stats = new List<InvCard>();
